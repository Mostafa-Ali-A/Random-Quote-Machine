...
const generateColors = function () {
    const colors = [
        "#CD5C5C", "#F08080", "#FA8072", "#E9967A", "#FFA07A", "#DC143C", "#FF0000", "#B22222", "#8B0000", "#FF1493",
        "#C71585", "#DB7093", "#FF7F50", "#FF6347", "#FF4500", "#FF8C00", "#FF00FF", "#BA55D3", "#9370DB", "#8A2BE2",
        "#9400D3", "#9932CC", "#8B008B", "#800080", "#663399", "#4B0082", "#7B68EE", "#6A5ACD", "#483D8B", "#ADFF2F",
        "#7FFF00", "#7CFC00", "#00FF00", "#32CD32", "#98FB98", "#90EE90", "#00FA9A", "#00FF7F", "#3CB371", "#2E8B57",
        "#228B22", "#008000", "#006400", "#6B8E23", "#808000", "#556B2F", "#66CDAA", "#008B8B", "#008080", "#00FFFF",
        "#7FFFD4", "#40E0D0", "#48D1CC", "#00CED1", "#5F9EA0", "#4682B4", "#1E90FF", "#6495ED", "#4169E1", "#0000FF",
        "#0000CD", "#00008B", "#000080", "#191970", "#BC8F8F", "#B8860B", "#CD853F", "#D2691E", "#8B4513", "#A0522D",
        "#A52A2A", "#800000", "#808080", "#696969", "#778899", "#708090", "#2F4F4F", "#000000"
    ];

    var arrColor = Math.floor(Math.random() * colors.length);
